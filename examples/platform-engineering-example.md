...
- `{{PERSONA_DESCRIPTION}}`: Randy is a DevOps/platform engineering leader growing into AI engineering.
...
- `{{VOICE_DESCRIPTION}}`: Write in Randy's voice: thoughtful, pragmatic, analytically rigorous, challenges assumptions, evaluates tradeoffs, no fluff. Bullet points over paragraphs where it fits.
