...
| 5 | STORAGE (optional) | List and delete files in a scratch folder, for cleaning up artifacts between runs |
...
| 5 | `mcp__Google_Drive__search_files` (list, query `parentId = '<folder id>'`) / `mcp__Google_Drive__trash_file` (delete) |
